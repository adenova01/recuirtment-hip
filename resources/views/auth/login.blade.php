...
<body>
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="{{url('/cek_login')}}" method="post">
                @csrf
  ...
  <!-- container-scroller -->
  <!-- plugins:js -->
  <script src="/assets_dashboard/vendors/js/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <!-- End plugin js for this page -->
  <!-- inject:js -->
  <script src="/assets_dashboard/js/off-canvas.js"></script>
  <script src="/assets_dashboard/js/hoverable-collapse.js"></script>
  <script src="/assets_dashboard/js/template.js"></script>
  <script src="/assets_dashboard/js/settings.js"></script>
  <script src="/assets_dashboard/js/todolist.js"></script>
  <!-- endinject -->
</body>

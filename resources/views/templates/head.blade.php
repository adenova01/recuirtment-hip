...
<link rel="stylesheet" href="{{url('/assets_dashboard/vendors/ti-icons/css/themify-icons.css')}}">
<link rel="stylesheet" type="text/css" href="{{url('/assets_dashboard/js/select.dataTables.min.css')}}">
...
<!-- endinject -->
<link rel="shortcut icon" href="{{url('/assets_dashboard/images/hip_no_bg.png')}}"/>
